Template.home.onRendered(function () {
    ...
    MESSAGES.push({
        delay: 2200,
        text: "You look so pretty today"
    });

    MESSAGES.push({
        delay: 3600,
        text: "I really excited to give you something special"
    });
    ...
    initialise = function() {
        ...
        for (index = j = 0, len = MESSAGES.length; j < len; index = ++j) {
            text = MESSAGES[index];
            $message.append("<p class='small unwrapped' style=' word-wrap: break-word;'>");
        }
    ...
    Meteor.setTimeout(function () {
        swal("Click the HEART");
        $("body").append('<div id="wrap" style="display:none;"> <div id="iWrap"> <i class="icon-heart heart-size"></i> </div> </div>');
        $("#wrap").fadeIn("slow");
